...
git submodule update --init --recursive --remote scripts/sh/shlibs # ` git submodule help ` and https://git-scm.com/book/en/v2/Git-Tools-Submodules have more information.  This book is hosted at https://github.com/progit/progit2
# up.sh EOF
